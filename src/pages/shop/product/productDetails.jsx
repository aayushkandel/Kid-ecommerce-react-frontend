...
const getProductDetails = async () => {
  try {
    ...
    if (
      ...
      productData.product_variant_id !== undefined
    ) {
      try {
        ...
        console.log("No product rate found");

        setProductRate(null);
        setSelectedVariant(null);
      }
    } else {
      console.log("No product variants for this product");
...
if (loading) {
return ( <div className="min-h-screen flex items-center justify-center"> <p className="text-gray-500">
Loading product... </p> </div>
);
}
...
const handleAddToCart = async () => {
  ...
  try {
    ...
    // Change button after successful API call
  ...
  {currentStock <= 0
    ...
    <div className="mt-20">
      ...
      <div className="py-10 text-gray-600 leading-relaxed text-[15px]">
        ...
        {activeTab === "additional" && hasVariants && (
